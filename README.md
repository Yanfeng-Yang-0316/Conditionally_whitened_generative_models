...
This repository contains the codes of *Conditionally whitened generative models (CW-Gen)*, accepted by ICLR 2026. CW-Gen is a framework that enhances probabilistic time series forecasting by incorporating conditional mean and covariance into generative models such as diffusion and flow matching. 
...
## Environment
We adopts the [env of NsDiff](https://github.com/wwy155/NsDiff/blob/main/requirements.txt). There are some additional packages, and you can just pip install them.
