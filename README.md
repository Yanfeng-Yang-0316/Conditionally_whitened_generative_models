...
```
I wrote the code really in a hurry, so there might be some minor, simple bugs (like nonexistent path etc). These bugs are easy to fix, and don't effect the results.
